<template>
  <v-container>
    <v-row justify="center" align="center">
      <v-col cols="12" md="5">
        ...
        >
          ...
          <v-date-picker v-model="start" @input="datePicker1 = false"></v-date-picker>
        </v-menu>
      </v-col>
      ...
      <v-col cols="12" md="5">
        ...
        >
          <template v-slot:activator="{ on }">
            <v-text-field v-model="end" label="End" prepend-icon="mdi-calendar" readonly v-on="on"></v-text-field>
          </template>
          <v-date-picker v-model="end" @input="datePicker2 = false"></v-date-picker>
        </v-menu>
      </v-col>
    ...
    <v-row>
      <v-col cols="12">
        <v-chip class="my-3" color="orange" label text-color="white">论坛整体情感倾向：</v-chip>
        <v-card min-height="500" flat :loading="sentitiveLoading" style="background:none">
          <div class="pa-2" id="sentitive-chart"></div>
        </v-card>
      </v-col>
      <v-col cols="12">
        <v-chip class="my-3" color="orange" label text-color="white">论坛热点：</v-chip>
        <v-card min-height="500" flat :loading="keywordLoading" style="background:none">
          <div class="ma-5" id="keyword-chart"></div>
        </v-card>
      </v-col>
      <v-col cols="12" md="6">
        <v-chip class="my-3" color="orange" label text-color="white">热门话题（一级分类）：</v-chip>
        <v-card min-height="500" flat :loading="topicLoading1" style="background:none">
          <div class="ma-5" id="topic-chart1"></div>
        </v-card>
      </v-col>
      <v-col cols="12" md="6">
        <v-chip class="my-3" color="orange" label text-color="white">热门话题（二级分类）：</v-chip>
        <v-card min-height="500" flat :loading="topicLoading2" style="background:none">
          <div class="ma-5" id="topic-chart2"></div>
        </v-card>
      </v-col>
    </v-row>
    <v-chip class="my-3" color="orange" label text-color="white">帖子负面消息排行榜：</v-chip>
    ...
    <v-chip class="my-3" color="orange" label text-color="white">帖子热度排行榜：</v-chip>
    <v-card class="py-3" flat :loading="hotPostLoading" style="background:none" min-height="500">
      <v-expansion-panels>
